...
export default function Filter({ keywords, onRemoveClick, onClearClick }) {
    return (
        <div className={`w-full max-w-[1110px] min-h-[72px] bg-white rounded-md flex justify-between items-center sm:px-[24px] px-10 py-5 relative bottom-9 shadow-custom sm:mb-[22px] ${keywords.length === 0 && 'invisible'}`}>
